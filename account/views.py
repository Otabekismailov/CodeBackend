...
from .serializers import RegisterSerializer, UserSerializer, LoginSerializer, SendEmailVerificationCodeSerializer, \
    CheckEmailVerificationCodeSerializer, UserDetailSerializer, EmailVerificationCodeSerializer
...
class VerificationCodeWithParams(generics.ListAPIView):
    queryset = VerificationCode.objects.all()
